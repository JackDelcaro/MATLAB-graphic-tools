% get_absolute_position Computes the absolute position of a tile within a nested TiledLayout
%   absolute_position = get_absolute_position(tile) calculates the absolute position of
...
function absolute_position = get_absolute_position(tile)
    % Initialize absolute position with the position of the input tile
    absolute_position = tile.Position;
